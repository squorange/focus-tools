...
export default function Home() {
  ...
  // Focus queue operations (extracted hook)
  const {
    addToQueue: handleAddToQueue,
    updateStepSelection: handleUpdateStepSelection,
    removeFromQueue: handleRemoveFromQueue,
    completeRoutine: handleCompleteRoutine,
    skipRoutine: handleSkipRoutine,
    markRoutineIncomplete: handleMarkRoutineIncomplete,
    resetFromTemplate: handleResetFromTemplate,
    moveQueueItem: handleMoveQueueItem,
    moveQueueItemUp: handleMoveQueueItemUp,
    moveQueueItemDown: handleMoveQueueItemDown,
    moveTodayLine: handleMoveTodayLine,
    reorderQueue: handleReorderQueue,
  } = useFocusQueue(state, setState, { showToast, scheduleNotificationForTask, cancelNotificationForTask });

  // Task CRUD operations (extracted hook)
  const {
  ...
  } = useTaskCrud(state, setState, {
    showToast, cancelNotificationForTask, scheduleNotificationForTask,
    setPreviousView, setTaskCreationOpen, handleJumpToFilter,
  });

  // Focus session controls (extracted hook)
  const {
    startFocus: handleStartFocus,
    startRecurringFocus: handleStartRecurringFocus,
    pauseFocus: handlePauseFocus,
    resumeFocus: handleResumeFocus,
    stuck: handleStuck,
    exitFocus: handleExitFocus,
  } = useFocusSession(state, setState, {
    aiAssistant, previousView, setPreviousView, setActiveDrawer,
  });
